package com.capgemini.moviecatalogue.controller;
...
import com.capgemini.moviecatalogue.entity.Movie;
import com.capgemini.moviecatalogue.entity.MovieCatalog;
import com.capgemini.moviecatalogue.entity.Rating;
import com.capgemini.moviecatalogue.entity.UserRating;
...
public class MovieCatalogController {
	...
	public ResponseEntity<List<MovieCatalog>> getMovieCatalog(@PathVariable String userId) {
		...
		UserRating userRatings = 
				restTemplate.getForEntity("http://MOVIE-RATING-SERVICE/ratings/" + userId,UserRating.class)
				.getBody();
		...
		for (Rating rating : movieRatings) {
			...
			movieCatalog.add(new MovieCatalog(movie.getMovieTitle(), movie.getMovieDescription(), movie.getRating()));
		}
